...
#Ratings Scale
    if i == 1 or i == 4 or i == 7 or i == 10 or i == 11 or i == 14 or i == 17 or i == 20 or i == 21 or i == 24 or i == 27 or i == 30:
        ...
        game_type = 1
    data_to_write = str(100+i) + ',' + str(game_type) + ',' + str(bet)+ ',' + str(wallet) + ',' + str(winning) + ',' + str(len(players_cards)-2) + ',' + str(conf_level_response) + ',' + str(excited_response) + ',' + str(proud_response) + ',' + str(strong_response) + ',' + str(nervous_response) + ',' + str(distressed_response)+ ',' + str(ashamed_response) + '\n'
