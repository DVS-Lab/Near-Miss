...
#Get player ID
playerDlg = gui.Dlg(title = "21 Game Version 3")
...
for i in range(1, 31):
    if i == 11 or i == 21:
        ...
        win.flip()
        event.waitKeys(keyList = 'space')
    if i == 1 or i == 8 or i == 11 or i == 18 or i == 21 or i == 28:
        prescriptions = ["If the sum of your cards is 14, you have a 0% chance of making money.",
                 "If the sum of your cards is 15, you have a 12.5% chance of making money.",
                 "If the sum of your cards is 16, you have a 25% chance of making money.", 
                 "If the sum of your cards is 17, you have a 37.5% chance of making money.",
                 "If the sum of your cards is 18, you have a 50% chance of making money.",
                 "If the sum of your cards is 19, you have a 62.5% chance of making money.",
                 "If the sum of your cards is 20, you have a 75% chance of making money.",
                 "If you hit when the sum of your cards is equal to 14, you have a 30% chance of busting.",
                 "If you hit when the sum of your cards is equal to 15, you have a 40% chance of busting.",
                 "If you hit when the sum of your cards is equal to 16, you have a 50% chance of busting.",
                 "If you hit when the sum of your cards is equal to 17, you have a 60% chance of busting.",
                 "If you hit when the sum of your cards is equal to 18, you have a 70% chance of busting.",
                 "If you hit when the sum of your cards is equal to 19, you have a 80% chance of busting.",
                 "If you hit when the sum of your cards is equal to 20, you have a 90% chance of busting.",]
        prescriptions_screen = visual.TextStim(win, font = 'Arial', text = str(prescriptions[random.randint(1,14)]))
        prescriptions_screen.draw()
        win.flip()
        core.wait(5.0)
    if i == 1 or i == 2 or i == 4 or i == 5 or i ==6 or i ==8 or i == 9 or i == 11 or i == 12 or i == 14 or i == 15 or i == 16 or i ==18 or i == 19 or i == 21 or i == 22 or i == 24 or i == 25 or i == 26 or i == 28 or i == 29:
        ...
        if sum(players_cards) < 21:
            ...
            if sum(players_cards) < sum(computers_cards) and sum(computers_cards) < 21:
                ...
                computers_cards_output = 'These are the computer\'s cards: ' + str(computers_cards)
                wallet = wallet - bet
...
#Near Miss Codes
    if i == 3 or i == 7 or i == 13 or i == 17 or i == 23 or i == 27:
...
#Ratings Scale
    if i == 1 or i == 4 or i == 7 or i == 10:
        ...
        event.waitKeys(keyList = 'space')
        """
        ratingsDlg = gui.Dlg(title = '21 Ratings')
        ratingsDlg.addField('How confident are you with your Blackjack playing abilities? Rate on a scale of 1-5: ')
        ratingsDlg.addField('Excited: ')
        ratingsDlg.addField('Proud: ')
        ratingsDlg.addField('Strong: ')
        ratingsDlg.addField('Nervous: ')
        ratingsDlg.addField('Distressed: ')
        ratingsDlg.addField('Ashamed: ')
        ratingsDlg.show()
        """
        ...
        game_type = 1
    data_to_write = str(300+i) + ',' + str(game_type) + ',' + str(bet)+ ',' + str(wallet) + ',' + str(winning) + ',' + str(len(players_cards)-2) + ',' + str(conf_level_response) + ',' + str(excited_response) + ',' + str(proud_response) + ',' + str(strong_response) + ',' + str(nervous_response) + ',' + str(distressed_response)+ ',' + str(ashamed_response) + '\n'
